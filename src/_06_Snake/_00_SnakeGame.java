...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Use the arrow keys to move and eat apples. Don't touch the boundaries or yourself. Good luck!";
	...
	private void gameOver() {
		...
		String playAgain = JOptionPane.showInputDialog("Your snake is dead :( Would you like to try again?");
